...
public:
	...
	*/
	bool Load( const TCHAR *fileNameStr, ImageLibFormat format = IMAGELIB_FORMAT_UNKNOWN );

	bool Load( SQStream* file, ImageLibFormat format = IMAGELIB_FORMAT_UNKNOWN );
	bool Decode( SQStream* file, ImageLibFormat format );
	bool Decode( FILE *fptr, ImageLibFormat format );
	...
	*/
	bool Save( const TCHAR *fileNameStr, ImageLibFormat format = IMAGELIB_FORMAT_TGA );	
	bool Encode( FILE *fptr, ImageLibFormat format );
