...
struct IMD5_Progress
{
public:	

	virtual bool progress_function(	double dltotal,	double dlnow) = 0;
};
...
public:
	...
	static BOOL GetMD5(BYTE* pBuf, UINT nLength,char * OutMD5Str,IMD5_Progress* pp=NULL);
	static BOOL GetMD5(HANDLE  File,char* OutMD5Str,IMD5_Progress* p=NULL);
	static BOOL GetMD5(LPCTSTR strFilePath,char* OutMD5Str,IMD5_Progress* pp=NULL);

	void setProgress(IMD5_Progress* p)
	{
		m_progress=p;
	}
protected:
