...
#include <sq_stdio.h>
#include <sq_stdmath.h>
#include <sq_stdstring.h>
#include <sq_stdaux.h>
#include <sq_stdblob.h>
#include <sq_stdsystem.h>
...
{
	SquirrelObject ret;
	if(SQ_SUCCEEDED(sq_compilebuffer(_VM,s,(int)STRLEN(s),debugInfo,1))) {
		ret.AttachToStackObject(-1);
		sq_pop(_VM,1);
		return ret;
	}
