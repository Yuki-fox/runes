...
BOOL SQUIRREL_API CreateStaticClass(HSQUIRRELVM v,SquirrelClassDecl *cd);
BOOL SQUIRREL_API CreateStaticNamespace(HSQUIRRELVM v,ScriptNamespaceDecl *sn);
BOOL SQUIRREL_API CreateClass(HSQUIRRELVM v,SquirrelClassDecl *cd);
BOOL SQUIRREL_API InitScriptClasses(HSQUIRRELVM v);
BOOL SQUIRREL_API CreateNativeClassInstance(HSQUIRRELVM v,const SQChar *classname,SQUserPointer ud,SQRELEASEHOOK hook);
