...
#ifndef MING_BASE_ITERATORBASE_H_
#define MING_BASE_ITERATORBASE_H_

//#include "gui_Base.h"
//#include <util/Util_HashtableIterator.h>
//using namespace util;

// Start of base namespace section
namespace base
{
/*!
\brief
...
public:
	...
	*/
	ConstBaseIterator(typename T::Iterator start_iter, typename T::Iterator end_iter) :
	...
	*/
	typename T::Key	getCurrentKey(void) const
	{
		return d_currIter.key();
	}
	...
	*/
	typename T::Value	getCurrentValue(void) const
	{
		return d_currIter.value();
	}
	...
	*/
	typename T::Value	operator*() const
	{
		return d_currIter.value();
	}
...
#endif	// end of guard MING_BASE_ITERATORBASE_H_
