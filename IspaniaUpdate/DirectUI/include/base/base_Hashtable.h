#ifndef MING_BASE_HASHTABLE_H
#define MING_BASE_HASHTABLE_H
...
template <> class Hash<uint8_t> 
{public: int operator()( const uint8_t& x ) const {return (int)x;}};
template <> class Hash<uint16_t> 
{public: int operator()( const uint16_t& x ) const {return (int)x;}};
template <> class Hash<uint32_t> 
{public: int operator()( const uint32_t& x ) const {return (int)x;}};
...
#include <base/base_Hashtable.inl>


} // base


#endif // MING_BASE_HASHTABLE_H
