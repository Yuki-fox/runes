...
public:
   ...
   static void DoPaintBitmap(HDC hDC, CPaintManagerUI* pManager, HBITMAP hBmp, RECT destRc,RECT rcBitmap);
   ...
   static void DoPaintButton2(HDC hDC, CPaintManagerUI* pManager, RECT rc,HBITMAP* hBmpList ,UINT uState);   
   ...
   static void DoPaintCheckBox(HDC hDC, CPaintManagerUI* pManager, RECT rcItem, LPCTSTR pstrText, UINT uState, UINT uStyle);
