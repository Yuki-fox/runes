...
{
public:
   CListElementUI(SquirrelObject& so);

      virtual ~CListElementUI(){}
...
{
public:
   CListHeaderUI(SquirrelObject& so);
...
{
public:
   CListHeaderItemUI(SquirrelObject& so);
...
{
public:
   CListFooterUI(SquirrelObject& so);

   virtual ~CListFooterUI(){}
...
{
public:
   CListLabelElementUI(SquirrelObject& so);
      virtual ~CListLabelElementUI(){}
...
{
public:
   CListTextElementUI(SquirrelObject& so);
...
{
public:
   CListExpandElementUI(SquirrelObject& so);
