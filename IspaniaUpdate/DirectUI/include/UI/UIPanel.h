...
{
public:
   CTaskPanelUI(SquirrelObject&so);
   ~CTaskPanelUI();
...
{
public:
   CNavigatorPanelUI(SquirrelObject&so);
...
{
public:
   CNavigatorButtonUI(SquirrelObject&so);
...
{
public:
   CSearchTitlePanelUI(SquirrelObject&so);
...
{
public:
   CPaddingPanelUI(SquirrelObject&so);
...
{
public:
   CImagePanelUI(SquirrelObject&so);
...
{
public:
   CTextPanelUI(SquirrelObject&so);
...
{
public:
   CWarningPanelUI(SquirrelObject&so);
